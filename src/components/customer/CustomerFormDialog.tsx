...
import { createCustomer, updateCustomer } from "@/services/customer/customerManagement";

interface ICustomerFormDialogProps {
    open: boolean;
    onClose: () => void;
    onSuccess: () => void;
    customer?: ICustomer;
...
const CustomerFormDialog = ({
    ...
    const [state, formAction, isPending] = useActionState(
        isEdit ? updateCustomer.bind(null, customer?.id as string) : createCustomer,
        null
    );
                    ...
                    <div className="flex-1 overflow-y-auto px-6 space-y-4 pb-4">
                        ...
                        <Field>
                            ...
                            <Input
                                ...
                                defaultValue={state?.formData?.name || customer?.name || ""}
                            />
                        ...
                        <Field>
                            ...
                            <Input
                                ...
                                defaultValue={state?.formData?.email || customer?.email || ""}
                                disabled={isEdit}
                            />
